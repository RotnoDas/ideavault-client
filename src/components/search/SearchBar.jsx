        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full">
            ...
            <div className="sm:w-56 shrink-0 relative">
                <select 
                    ...
                    className="w-full h-full min-h-14 px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl text-slate-800 dark:text-slate-100 shadow-sm focus:ring-2 focus:ring-blue-600 focus:outline-none cursor-pointer appearance-none"
